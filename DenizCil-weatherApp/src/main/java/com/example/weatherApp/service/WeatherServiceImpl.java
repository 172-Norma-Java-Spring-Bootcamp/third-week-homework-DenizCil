...
public class WeatherServiceImpl implements WeatherApiService{
    ...
    public CurrentWeatherApi getCurrentWeather(String cityName) {
        final String baseUrl = "http://api.weatherapi.com/v1/current.json?key=01f1e1f1870e4e9f8d7202447221404="+cityName+"&aqi=yes";
    ...
    public ForecastWeatherApi getForecastWeather(String cityName, int day) {
        final String baseUrl = "http://api.weatherapi.com/v1/forecast.json?key=01f1e1f1870e4e9f8d7202447221404&q="+cityName+"&days="+day+"&aqi=yes&alerts=yes";
